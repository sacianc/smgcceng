...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories
{
    ...
    public static class PartitionKeyNames
    {
        ...
        public static class NotificationDataTable
        {
            ...
            /// <summary>
            /// Schedule Sent notifications partition key name.
            /// </summary>
            public static readonly string ScheduleSentNotificationsPartition = "ScheduleSentNotifications";
        }
        ...
        /// <summary>
        /// Scheduled Notification data table partition key names.
        /// </summary>
        public static class ScheduleNotificationDataTable
        {
            /// <summary>
            /// Table name for notification data table
            /// </summary>
            public static readonly string TableName = "ScheduledNotifications";

            /// <summary>
            /// Default partition - should not be used.
            /// </summary>
            public static readonly string ScheduleNotificationsPartition = "ScheduledNotifications";
        }
    }
}
