...
import ScheduledMessages from '../src/components/ScheduledMessages/scheduledMessages';
import StatusTaskModule from './components/StatusTaskModule/statusTaskModule';
import ScheduleTaskModule from './components/StatusTaskModule/scheduleTaskModule';
import './App.scss';
                ...
                <div className="appContainer">
                    <BrowserRouter>
                        <Switch>
                            ...
                            <Route exact path="/viewschedule/:id" component={ScheduleTaskModule} />
