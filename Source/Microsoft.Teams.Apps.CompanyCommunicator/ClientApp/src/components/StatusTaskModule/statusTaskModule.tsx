...
class StatusTaskModule extends React.Component<RouteComponentProps, IStatusState> {
    ...
    public render(): JSX.Element {
        let menuItems: {}[] = [];
        menuItems.push(<MenuItem key="Sent" content="Sent" > Sent ({this.state.message.succeeded})
                        </MenuItem>);
        menuItems.push(<MenuItem key="Not delivered" content="Not delivered" >Not delivered ({this.state.message.failed})
        </MenuItem>);
        menuItems.push(<MenuItem key="Throttled" content="Throttled">Throttled ({this.state.message.throttled})
        </MenuItem>);
        menuItems.push(<MenuItem key="Acknowledged" content="Acknowledged">Acknowledged ({this.state.message.acknowledged})
        </MenuItem>);
